...
export class VFXPreviewPanel extends Component<IVFXPreviewPanelProps> {
	public render(): ReactNode {
		const { scene, engine } = this.props.vfxEditor.state;

		return (
			<div className="flex flex-col w-full h-full bg-background overflow-hidden">
				{/* Canvas container */}
				<div className="flex-1 relative overflow-hidden">
					<canvas ref={(r) => (this.props.vfxEditor.canvasRef = r)} className="absolute inset-0 w-full h-full bg-background" style={{ display: "block" }} />
